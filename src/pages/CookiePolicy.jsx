...
import { Shield, Clock, FileText, Calendar, Mail, AlertCircle, Loader2, Home, ChevronRight, Cookie } from "lucide-react";
    ...
    async function loadPage() {
      ...
      try {
        ...
        if (result.data.success) {
          ...
          setError(result.data.error || 'Failed to load cookie policy');
        }
      } catch (err) {
    ...
    <div className="min-h-screen bg-white">
      ...
      {loading && (
        <div className="min-h-[60vh] flex flex-col items-center justify-center">
          ...
          <p className="text-gray-600 text-lg">Loading cookie policy...</p>
        </div>
      )}
                ...
                <div className="bg-blue-50 border-2 border-blue-200 rounded-2xl p-6 mb-8 flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-blue-800 leading-relaxed">
                      You can manage your cookie preferences at any time using our cookie banner at the bottom of the page.
                    </p>
                  </div>
                </div>
