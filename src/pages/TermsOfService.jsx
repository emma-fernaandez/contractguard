    ...
    async function loadPage() {
      ...
      try {
        ...
        if (result.data.success) {
          ...
          setError(result.data.error || 'Failed to load terms of service');
        }
      } catch (err) {
        console.error('Error loading terms of service:', err);
        setError('Unable to load terms of service. Please try again later.');
      } finally {
        setLoading(false);
      }
    }
      ...
      {error && !loading && (
        <div className="min-h-[60vh] flex flex-col items-center justify-center px-6">
          <div className="max-w-md text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-3">Unable to Load Terms</h2>
